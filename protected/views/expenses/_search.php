                                                ...
                                                <form role="form" class="form-horizontal">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label class="col-md-1 control-label"> Search By Expenses ID</label>
                                                            <div class="col-md-2">
															...
															<label class="col-md-1 control-label"> Search By Expense Name</label>
                                                            <div class="col-md-2">
                                                            <div class="input-icon right">
															...
															<?php echo $form->textField($model,'name',array('class'=> 'form-control')); ?>	
															 ...
															 <label class="col-md-1 control-label"> Search By Expense Amount</label>
                                                            <div class="col-md-2">
                                                            <div class="input-icon right">
